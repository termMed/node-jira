...
var JiraApi = exports.JiraApi = function (protocol, host, port, username, password, apiVersion, verbose, strictSSL) {
    ...
    this.doRequest = function (options, callback) {
        ...
        console.log(JSON.stringify(options.auth));
...
(function () {
    ...
    //
    // [Jira Doc](http://docs.atlassian.com/jira/REST/latest/#id290709)
    this.findIssueCustomField = function (project, field, value, callback) {
        var jqlString = 'project="' + project + '" and ' + field + '~"' + value+'"';
        var uri = this.makeUri('/search?jql=' + jqlString);
        console.log(uri);
        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: uri,
